...
@Component({
  selector: 'da-AllDemands',
  templateUrl: './AllDemands.component.html',
  styleUrls: ['./AllDemands.component.scss'],
})
export class AllDemandComponent implements OnInit {
  ...
  getList() {
    this.busy = this.listDataService.getAllDemands(this.pager).subscribe((res) => {
