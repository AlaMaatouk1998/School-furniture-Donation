...
let UserService = class UserService {
    ...
    login(user) {
        return this.validateUser(user.email, user.password).pipe((0, operators_1.switchMap)((user) => {
            if (user) {
                return this.authService.generateJWT(user).pipe((0, operators_1.map)((jwt) => {
    ...
    updateOne(id, user) {
        ...
        delete user.role;
        return (0, rxjs_1.from)(this.userRepository.update(id, user)).pipe((0, operators_1.switchMap)(() => this.findUser(id)));
    }
